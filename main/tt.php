...
if (isset($_REQUEST['tiketNo'])){
    ...
    if (isset($_POST['reply'])){
        if($_POST['chanel'] == "sms"){
            ...
            $subject = "KRA CUSTOMER SUPPORT FOR TICKET NO -- $tiketNo";
...
function notify_agents($agents){
  ...
  $agent =  getAgentEmailByID($agents);
   ...
   $massage = " Dear $name you have been allocated a ticket. Please login to the system and resolve the ticket kesracrm.kra.go.ke .For any guidance contact caroline.wangari@kra.go.ke";
   $subject =  "ALLOCATION OF COMPLAINT TICKET";
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <?php 
              ...
              echo'<script>
                setTimeout(()=>{
                  window.open("/crm/main/trt.php", "_self");
                }, 3000)
                    ...
                    <tbody>
                         <?php
                            ...
                            foreach($users as $row){
                                ...
                                print("<td>");
                                print('<a class="btn btn-success" href="/crm/main/tt.php?tiketNo='.$tiketNo.'&action=assign&uid='.$row['username'].'"><i class="fa fa-edit"></i></a>');
                                print("</td>");
                                print("<td>");
                                print('<a class="btn btn-danger" href="/crm/main/tt.php?tiketNo='.$tiketNo.'&action=assign&uid='.$row['username'].'"><i class="fa fa-users"></i></a>');
                                print("</td>");
