...
include dirname(__DIR__) . '/mailer/src/PHPMailer.php';
include dirname(__DIR__) . '/mailer/src/SMTP.php';
include dirname(__DIR__) . '/mailer/src/Exception.php';
...
/*
    ...
    *
    */
function send_mail_by_PHPMailer($to, $subject, $message, $path=null)
{
