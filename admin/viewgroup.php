                  ...
                  <table class="table align-items-center table-flush" id="dataTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="/crm/admin/editcontact.php?id=<?php echo $row['id']; ?>" class="success "><i class="fa fa-edit"></i></a></td>
                        <td><a href="/crm/admin/delgroupc.php?id=<?php echo $row['id']; ?>&is=<?php echo $id; ?>" class=" btn-danger"><i class="fa fa-trash"></i></a></td>
                        <?php } ?>
                    </tbody>
                  </table>
                </div>
