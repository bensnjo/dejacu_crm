                  ...
                  <table class="table align-items-center table-flush" id="dataTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a  href="/crm/admin/smsgroup.php?id=<?php echo $row['id']?> "><i class="fa fa-paper-plane"></i></a></td>
                        <td><a  href="/crm/admin/delgroups.php?id=<?php $row['id']?>"><i class="fa fa-trash"></i></a></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
