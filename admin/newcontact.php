...
if (isset($_POST['add_contact'])){
    addcontact($groupid);
    $succcess = "Contact Added succcessfully";

if(isset($_SESSION['addition']) && $_SESSION['addition'] == "Contact added Successful "){
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          echo'<script>
          setTimeout(()=>{
            window.open("/crm/admin/viewgroup.php?id='.$groupid.'", "_self");
          }, 1000)
          ...
          <div class="col-lg-12">
              <div class="mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h4 class="m-0 font-weight-bold text-primary"> add Contact</h4>
                  <hr>
            ...
            <div class="row">
              ...
              <div class="form-group">
                <label>NAME</label>
                <input type="text" class="form-control" id="fnameInput" placeholder="Customer Name" name="contactName" required>
              </div>
              </div>
              ...
              <div class="form-group" style="margin-top: 10px">
                <button type="submit" class="btn btn-primary btn-block" name="add_contact">ADD CONTACT</button>
              </div>
              </div>
              <div class="col">
              </div>
