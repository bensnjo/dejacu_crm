...
// 
    ...
    $complain = mysqli_real_escape_string($db, $_POST['description1']);
    $Tstatus = mysqli_real_escape_string($db, $_POST['tStatus']);
    ...
    $query = "UPDATE `insidence` SET 
    `mobileNumber`='$mobileNumber',
    `serialNumber`='$serialNumber',
    `dStatus`='$dStatus',
    `status`='$Tstatus',
    `AssignedTo`='$assignedto',
    `ticketComment`='$complain'
     WHERE `id`='$id'";
     
         if(mysqli_query($db, $query)){
          if(isset($_SESSION['addition']) && $_SESSION['addition'] == "Ticket .$ticketNumber. updated Successfully "){
            $succcess = "Ticket Updated Successfully";
            unset($_SESSION['addition']);
          }

         //
         $audit = "INSERT INTO audit_trail (username, time_stamp, `action`, results, impact, ip_address)
         VALUES('$user','$d', 'update_ticket', 'success', '$ticketNumber', '$ip')";
          ...
          <form action="" method="POST" class="p-4">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputLastName" 
                      placeholder="Mobile Number" name="mobileNumber" value= "<?php echo $mobileNumber; ?>">
                    </div>
                    </div>
                    <div class="col">
                    <div class="form-group">
                      ...
                      placeholder="Device Serial Number" name="serialNumber" value= "<?php echo $serialNumber;?>" required >
                    </div>
                    </div>
                    </div>
                ...
                <div class="row">
                  <div class="col">
                    <div class="form-group">
                        ...
                        <select name="dStatus" class="form-control" id="exampleInputPassword">
                          <option><?php  echo $deviceStatus;?></option>
                    ...
                    <div class="col">
                      <div class="form-group">
                          ...
                          <select name="tStatus" class="form-control" id="exampleInputPassword">
                            <option><?php echo $status; ?></option>
                            <option value="bookedin">OPEN</option>
                      ...
                      <div class="col">
                          <div class="form-group">
                              ...
                              <select name="assigned" class="form-control" id="exampleInputPassword">
                                <option><?php echo $AssignedTo;?></option>
                                  <?php
                  ...
                  <div>
                    ...
                    <div> 
                      ...
                      <textarea type="text" class="form-control" id="exampleInputPassword" 
                       name="description1" ><?php echo  $comment; ?></textarea>
                    </div>
                    </div>
                    <div class="form-group">
                      <button type="submit" class="btn btn-primary btn-block" name="addETicket" >SAVE TICKET</button>
