...
if(isset($_SESSION['tddition']) && $_SESSION['tddition'] == "Team added Successful "){
  $succcess = $_POST['team']." Team Added success";
...
<div class="card col-xl-12 col-md-12 mb-4 p-3">
          <h4>Add or Update Team </h4>
          <hr>
          <form action="" method="POST" class = "row">
                    ...
                    <div class="form-group col-lg-4">
                      ...
                      <input type="text" class="form-control" id="exampleInputLastName"
                       placeholder="Enter Team Name" name="team">
                    </div>
                    ...
                    <div class="form-group col-lg-4">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp"
                        placeholder="Add description" name = "disp" >
                    </div>
                    
                    
                    
                    <div class="form-group col-lg-4" >
                      <button type="submit" class="btn btn-primary btn-block" name="add" style="margin-top: 25px">SAVE</button>
                    </div>
                    ...
                    <tbody>
                         <?php
                            ...
                            foreach($teams as $row){
                                ...
                                print("<td>");
                                print('<button class="btn btn-success" title="Edit"><i class="fa fa-edit"></i></button>');
                                print("</td>");
