...
<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php" style="background-color:#FFFFFF">
        <div class="sidebar-brand-icon">
          <img src="img/devajuLogo.jpeg">
        </div>
        <div class="sidebar-brand-text mx-3" style="color:#000000">Dejavu CRM</div>
      </a>
     ...
     <li class="nav-item">
        ...
        <div id="jobCards" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="jobCards.php">JOB CARDS</a>
            <!-- <a class="collapse-item" href="vcustomers.php">EDIT A CUSTOMER</a> -->
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTable" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="addteam.php">TEAMS</a>
            <a class="collapse-item" href="addDpmt.php">DEPARTMENTS</a>
          </div>
        </div>
      </li>
      <!--  -->
 ...
 <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="">
          <i class="fas fa-satellite-dish fa-2x text-danger"></i>
