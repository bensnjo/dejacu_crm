      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          if (isset($succcess)) {
           ...
           echo '<script>
          setTimeout(()=>{
            window.open("/crm/admin/smsrh.php", "_self");
          }, 2000)
         </script>';
          }
          ?>
          <div class="card col-xl-12 col-md-12 mb-4 p-5">
            ...
            <div class="row">
              ...
              <div class="form-group">
                <label>SMS</label>
                <textarea class="form-control" name="smsname" id="fnameInput" placeholder="Type your sms here.." rows="4" required></textarea>
              </div>
              </div>
              </div>
              <div class="row">
              ...
              <div class="form-group" style="margin-top: 10px">
                <button type="submit" class="btn btn-primary btn-block" name="sms_group">SEND SMS</button>
              </div>
              </div>
              <div class="col">
              </div>
